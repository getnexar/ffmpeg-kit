                          ...
                          const char *path, const char *fmt_spec)
{
    static const struct {
        ...
        { ENC_STATS_FRAME_NUM_IN,   "ni",       0U, 0U, 1U      },
        { ENC_STATS_TIMEBASE,       "tb"                        },
        { ENC_STATS_TIMEBASE_IN,    "tbi",      0U, 0U, 1U      },
        { ENC_STATS_PTS,            "pts"                       },
        { ENC_STATS_PTS_TIME,       "t"                         },
        { ENC_STATS_PTS_IN,         "ptsi",     0U, 0U, 1U      },
        { ENC_STATS_PTS_TIME_IN,    "ti",       0U, 0U, 1U      },
        { ENC_STATS_DTS,            "dts",      0U, 1U, 0U      },
        { ENC_STATS_DTS_TIME,       "dt",       0U, 1U, 0U      },
        { ENC_STATS_SAMPLE_NUM,     "sn",       1U              },
        { ENC_STATS_NB_SAMPLES,     "samp",     1U              },
        { ENC_STATS_PKT_SIZE,       "size",     0U, 1U, 0U      },
        { ENC_STATS_BITRATE,        "br",       0U, 1U, 0U      },
        { ENC_STATS_AVG_BITRATE,    "abr",      0U, 1U, 0U      },
    };
